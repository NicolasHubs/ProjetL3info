...
namespace Assets.HeroEditor.Common.EditorScripts
{
    ...
    public class CharacterEditor : CharacterEditorBase
    {
        ...
        public void Load()
        {
			...
			//Debug.LogWarning("This feature is available only in PRO asset version: http://u3d.as/QCQ"); // http://u3d.as/14qb (MH) http://u3d.as/18Pr (SFH)
        ...
        public void Test()
        {
            ...
            {
                throw new Exception("Please add the following scene to Build Settings: " + TestRoomSceneName);
            }
